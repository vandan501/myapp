...
const Events = () => {
  ...
  <img src="https://images.pexels.com/photos/5905706/pexels-photo-5905706.jpeg?auto=compress&cs=tinysrgb&w=400" alt="Event" className="event-image" />
  <div className="event-date">June 24, 2020</div>
  <div className="event-details">
  <div className="event-title">International Conference on Special Needs Education</div>
  <div className="event-location"><SlLocationPin className="loc-icon" /> Istanbul, Turkey</div>
  </div>
</div>
<div className="event-card">
  <img src="https://images.pexels.com/photos/5905706/pexels-photo-5905706.jpeg?auto=compress&cs=tinysrgb&w=400" alt="Event" className="event-image" />
