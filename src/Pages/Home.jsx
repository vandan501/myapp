...
const Home = () => {
  ...
  useEffect(() => {
    // Intersection Observer to trigger odometer initialization when section is in view
              ...
              <div className="col-lg-6 col-md-12">
                <div className="manner-banner-content">
                  ...
                  <p>
                    ...
                    eCademy can offer you to enjoy the beauty of eLearning!
                  </p>
                      ...
                      <div className="single-course-box">
                        ...
                        <div className="course-content">
                          ...
                          <p>
                            ...
                            students to achieve a great career within a very
                            short time!{" "}
                          </p>
                          <p />
            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-sm-6 col-md-6">
                <div className="single-feature-box">
                  ...
                  <p>
                    Everyone prefers to enjoy learning at their own pace &amp;
              ...
              <div className="col-lg-3 col-sm-6 col-md-6">
                <div className="single-feature-box">
                  ...
                  <p>
                    Experienced teachers can assist in learning faster with
                    their best approaches!
                  </p>
                  <a href="#" target="__self" className="link-btn">
                    Start Now!
                  </a>
        ...
        <div className="about-area">
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-lg-6 col-md-12" ref={sectionRef}>
                <div className="about-content">
                  ...
                  <p>
                    ...
                    significant change to reach students from all over the
                    world! Giving options to learn better always can offer the
                    best outcomes!
                  </p>
                  <ul className="features-list">
                    <li>
                      <span>
                        <img src={experience} alt="" /> Expert Trainers
                      </span>
                    </li>
                    <li>
                      <span>
                        <img src={timeLeft} alt="" /> Lifetime Access
                      </span>
                    </li>
                    <li>
                      <span>
                        <img src={tutorials} alt="" /> Remote Learning
                      </span>
                    </li>
                    <li>
                      <span>
                        <img src={selfGrowth} alt="" /> Self Development
                      </span>
                    </li>
                  </ul>
                  <a href="#" className="default-btn">
                ...
                <div className="single-course-box">
                  ...
                  <div className="course-content">
                    ...
                    <p>
                      ...
                      learn the DL &amp; ANN topics in and out within a short
                      time!
                    </p>
                    <p />
                    <ul className="courses-box-footer d-flex justify-content-between align-items-center">
              ...
              <div className="col-lg-4 col-md-6">
                <div className="single-course-box">
                  ...
                  <div className="course-content">
                    ...
                    <p />
                    <p>
                      Learning Node.js is always exciting and it pushes students
                      to achieve a great career within a very short time!{" "}
                    </p>
                    <p />
                    <ul className="courses-box-footer d-flex justify-content-between align-items-center">
                      <li>
                ...
                <div className="w-100">
                  <div className="widgetWrap">
                    <div className="feedback-content">
                      ...
                      <p>
                        With the eCademy, you can study whenever and wherever
                      ...
                      >
                        <div className="single-feedback-item">
                          ...
                          <img className="quotes" src={quotation} alt="" />
                        </div>
                        <div className="single-feedback-item">
                          <p>
                      ...
                      <div className="feedback-slides"></div>
              ...
              <div className="row align-items-center">
                <div className="col-lg-8 col-md-12">
                  <div className="get-instant-courses-content">
                    ...
                    <p>
                      eCademy Self Development Course can assist you in bringing
                      the significant changes in personal understanding and
                      reshaping the confidence to achieve the best from your
                      career! We trust that learning should be enjoyable, and
                      only that can make substantial changes to someone!
                    </p>
                ...
                <div className="col-lg-4 col-md-12">
                  <div className="get-instant-courses-image">
                    <img src={man} className="mx-100 h-auto" alt="" />
        ...
        <div className="container">
          <div className="partner-area pt-100">
            <div className="section-title">
              ...
              <p>
                We always give extra care to our student's skills improvements
                and feel excited to share our latest research and learnings!
              </p>
            </div>
          </div>
            ...
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-12">
                <div className="view-all-courses-content">
                  ...
                  <p>
                    Learniphi training programs can bring you a super exciting
                  ...
                  <a href="#" className="link default-btn">
                    <img src={agenda1} alt="" className="defaultImg" /> View
                    Courses
                    <span
                      className="effect"
                      style={{ top: "46.5px", left: "101.172px" }}
        ...
        <div className="premium-access-area">
          <div className="container">
            <div className="premium-access-content">
              ...
              <a href="#" className="link default-btn">
                <img src={agenda1} alt="" className="defaultImg" /> Get Started
                Now
                <span
                  className="effect"
                  style={{ top: "46.5px", left: "101.172px" }}
