  ...
  return (
    ...
    <div className="course-card-info">
      ...
      <p className="course-description">
        Create a robust Todo application using Django, mastering
        essential web development skills like CRUD operations, user
        authentication, and responsive design. Perfect for beginners and
        intermediate developers aiming to build dynamic, database-driven
        web applications.
      </p>
